...
func newLoadBalancerController() (*LoadBalancerController, error) {
	...
	ctx, err := context.NewControllerContext(kubeClient, backendConfigClient, frontendConfigClient, nil, svcNegClient, nil, nil, nil, kubeClient /*kube client to be used for events*/, nil, fakeGCE, namer, "" /*kubeSystemUID*/, ctxConfig, klog.TODO())
	if err != nil {
