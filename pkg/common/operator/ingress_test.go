...
func TestReferencesSvcNeg(t *testing.T) {
	...
	ctx, err := context.NewControllerContext(kubeClient, nil, nil, nil, nil, nil, nil, nil, kubeClient /*kube client to be used for events*/, nil, gceClient, namer, "" /*kubeSystemUID*/, ctxConfig, klog.TODO())
	if err != nil {
