...
func newTestController(clusterType string, readOnlyMode bool) (*Controller, error) {
	...
	ctx, err := context.NewControllerContext(kubeClient, nil, nil, nil, nil, saClient, nil, nil, kubeClient /*kube client to be used for events*/, nil, gceClient, resourceNamer, kubeSystemUID, ctxConfig, klog.TODO())
	if err != nil {
